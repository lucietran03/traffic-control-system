...
|--------|--------|--------|
| `Cebtral_Controller` | `c_main` | `c_main.c` |
| `Intersection_Controller` | `lx_main` | `lx_main.c` |
| `Railway_Controller` | `rlx_main` | `rlx_main.c` |
...
After completing the above steps, the workspace should contain:
