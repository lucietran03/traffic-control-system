...
| 3 | [03-protocol-contract.md](03-protocol-contract.md) | 10 verb trong `ipc_msg.h` — mọi outcome ACK/ACK_PENDING/NACK(reason)/ERROR | 45 |
...
| 5 | [05-fault-safety.md](05-fault-safety.md) | Watchdog, FAULT_SAFE, RC-06/09/10 gate fault | 21 |
...
| 2 | **`lx_fsm_local_fault_clear()` tồn tại nhưng không được nối vào bất kỳ trigger nào** — Lx vào FAULT_SAFE thì không có phím/lệnh nào đưa nó thoát ra, chỉ có cách khởi động lại process | Trung bình | Có thể là chủ ý (an toàn thật thường yêu cầu can thiệp vật lý), cần nhóm xác nhận đây là thiết kế hay thiếu sót |
