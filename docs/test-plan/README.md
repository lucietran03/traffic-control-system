...
|---|---|---|---|---|---|
| 1 | [01-usecase-functional.md](01-usecase-functional.md) | UC-01..10 (usecase.md) — hành vi đầu-cuối theo từng use case | Functional / black-box | Bàn phím (`lx_sensor.c`/`rlx_sensor.c`/`c_operator.c`) + quan sát console/log | 46 |
