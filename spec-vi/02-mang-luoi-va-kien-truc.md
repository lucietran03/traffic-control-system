...
**Giả định về khoảng cách và tốc độ [ASSUM, Proposed — Awaiting Confirmation]:** thay vì map lên 1 giao lộ thật có tên cụ thể, mạng lưới được tham số hoá với các giá trị đô thị tiêu biểu (tốc độ arterial 60 km/h, connector 50 km/h, khoảng cách giữa các giao lộ 300–500 m), phù hợp với giới hạn tốc độ đường đô thị điển hình tại Việt Nam theo QCVN 41:2019/BGTVT (đường đô thị thường giới hạn 50–60 km/h tuỳ loại đường và có/không dải phân cách). Cách này thoả yêu cầu của đề bài "at least attempt to base your design on a real intersection" với mục đích *suy ra phương pháp tính timing* (Mục 20), mà không thay đổi topology đã cho. Nếu sau này team muốn gắn vào 1 giao lộ thật cụ thể cho phần thuyết minh báo cáo (ví dụ 1 giao lộ tại Quận 2 có đường sắt/đường ray gần đó), đó chỉ là thay đổi tài liệu, không phải thay đổi kiến trúc.
...
| 2 | Advance/queue sensor **[HD]** | Cách vạch dừng khoảng 60–80 m về phía sau, chỉ ở 2 approach dẫn thẳng vào 1 railway crossing | `Lx` | `QUEUE_WARNING` | Ví dụ dễ hình dung: tưởng tượng 2 vạch trên đường — vạch A ngay tại đèn (đó là sensor #1), vạch B cách đó ~70 m về phía sau, gần đường ray hơn (đó là sensor #2). Sensor #1 chỉ trả lời 1 câu: "có xe nào đang chờ đèn không?". Sensor #2 trả lời 1 câu khác hẳn: "hàng xe đã xếp dài tới tận vạch B chưa?" — nếu có, nghĩa là hàng xe đang dài dần và sắp chạm tới đường ray. Sensor #2 chỉ đặt ở 2 approach dẫn thẳng vào railway crossing, vì mục đích duy nhất của nó là cảnh báo sớm cho logic giảm ùn tắc (Mục 16), không dùng để gia hạn pha đèn bình thường. Vẫn chỉ là 1 sensor trip nhị phân (có/không chạm), không đếm số xe. Phím bấm riêng. |
