...
| 2 | Tốc độ arterial 60 km/h; khoảng cách minh hoạ từng đoạn: `I1–I3=350m`, `I3–I5=400m`, `I2–I4=320m`, `I4–I6=380m` | Tốc độ phù hợp mức tối đa hiện hành cho loại đường đô thị đủ điều kiện theo Thông tư 38/2024/TT-BGTVT. Đề bài và lecture clarification yêu cầu khoảng cách hoặc travel time tham gia vào việc suy ra coordination, nên dùng số cụ thể có thể điều chỉnh thay vì chỉ nêu công thức. | Nuôi các offset phối hợp tính ở Mục 20: 21s, 24s, 19s và 23s | Không |
...
| 4 | Chu kỳ `PEAK_FIXED` đúng 90 giây: Pha A (arterial) 48s xanh+4s vàng+2s all-red=54s; Pha B (connector) 30s xanh+4s vàng+2s all-red=36s; không cố tình chia hết cho khoảng cách tàu 120s vì pre-emption là event-driven, không phụ thuộc ranh giới chu kỳ | Chu kỳ giao lộ cỡ trung tiêu biểu, tỷ lệ xanh 48:30 khớp ưu tiên arterial | Cơ sở cho timing fixed-mode và offset green-wave (Mục 20) | Không |
...
| 14 | Topology demo vẫn generic và được tham số hoá; giao lộ Mai Chí Thọ–Đồng Văn Cống chỉ được dùng làm contextual real-world reference | Thoả ý định đề bài mà không tuyên bố topology hoặc timing minh hoạ được khảo sát tại site đó | Giữ nguyên topology đề bài đồng thời làm cho real-world reference có thể truy vết | Không, theo thiết kế |
