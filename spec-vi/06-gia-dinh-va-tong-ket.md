...
| 2 | Tốc độ arterial 60 km/h, connector 50 km/h; khoảng cách minh hoạ từng đoạn: `I1–I3=350m`, `I3–I5=400m`, `I2–I4=320m`, `I4–I6=380m` (trong khung chung 300–500 m) | Giá trị đô thị Việt Nam tiêu biểu (phù hợp khung tốc độ QCVN 41:2019/BGTVT cho đường đô thị); đề bài nhắc 2 lần (brief gốc + lecture clarification) rằng khoảng cách phải được đo/ước lượng để suy ra timing, nên dùng số cụ thể để tính offset thật (xem Mục 20) thay vì chỉ nêu khung chung | Nuôi việc tính chu kỳ, tỷ lệ chia pha, offset phối hợp (offset tính ra: 21s, 24s, 19s, 23s — Mục 20) | Không |
