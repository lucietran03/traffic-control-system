...
int main(int argc, char *argv[]) {
    // Task 1B: Client code with ID 601
	printf("Welcome to the Task 1B Client with ID 601!\n");
	printf("This is Client 601 running\n");
...
int client(char *sname) {
    ...
    msg.ClientID = 601;      // client unique number to execute 
